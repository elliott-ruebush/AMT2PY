...
class LD821CombineApp(WorkerGuiMixin, tk.Tk):
    ...
    def _build_gui(self):
        ...
        self.var_sitename = tk.StringVar(value="")
        ...
        hint_site = "Short site code for output filename and NVSPL (e.g. CARE001, DENATRLA)"
    ...
    def browse_folder(self):
        ...
        hints = apply_deployment_hints(folder)
        self.var_sitename.set(hints.get("site_id", ""))
    ...
    def run_process(self):
        ...
        if not sitename:
            messagebox.showwarning(
                "Missing Site ID",
                "Enter a site ID before running (e.g. CARE001, DENATRLA).\n\n"
                "Site ID is filled automatically when you browse a folder when we can infer it from the path.",
            )
            return

...
Combines all SPL **Time History** files exported from **G4 Utility** into one sorted CSV for the deployment.
...
3. Enter **Site ID** — used in the output filename (e.g. `DENATRLA_Time History.csv`); autofill when you browse the folder
4. Run combine

...
- **MET/** — copy Feather MC microSD wind CSVs and `*MD.CSV` metadata; verify counts; clear card.
...
Browse to the MET folder; enter serial and deployment time zone. Prior combined outputs are skipped automatically.
